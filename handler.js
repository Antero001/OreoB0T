...
module.exports = {
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', this.getName(id)).replace('@desc', groupMetadata.desc) :
    ...
    .toAttachment();
                            this.sendFile(id, image.toBuffer(), 'wellcome.jpg', text, null, false, {
                                contextInfo: {
                                    mentionedJid: [user]
                                }
                            })
   ...
   .setMember(groupMetadata.participants.length)
   .toAttachment();
                            this.sendFile(id, image.toBuffer(), 'goodbye.jpg', text, null, false, {
                                contextInfo: {
                                    mentionedJid: [user]
                                }
                            })
